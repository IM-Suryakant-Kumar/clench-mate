...
router.route("/logout").get(controllers_1.logout);
router
    .route("/me")
...
router.route("/follow").post(middlewares_1.authenticateUser, controllers_1.followUser);
router.route("/unfollow").post(middlewares_1.authenticateUser, controllers_1.unfollowUser);
