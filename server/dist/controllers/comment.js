...
exports.createComment = (0, middlewares_1.asyncWrapper)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const comment = yield models_1.Comment.create(Object.assign({ author: req.userId }, req.body));
    res.status(200).json({ comment });
}));
exports.getComments = (0, middlewares_1.asyncWrapper)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.updateComment = (0, middlewares_1.asyncWrapper)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const comment = yield models_1.Comment.findByIdAndUpdate(req.params.id, req.body, {
        new: true,
    });
    res.status(200).json({ comment });
}));
