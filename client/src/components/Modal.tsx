...
export const Modal = () => {
	...
	return (
		...
		>
			...
			/>
			<div className="z-20 w-11/12 max-w-sm bg-primary border-2 border-gray-200 rounded-xs p-4 flex flex-col gap-4">
				<textarea
					name="content"
				...
				/>
				<button
					className="ml-auto bg-logo text-primary font-bold px-8 py-1.5 rounded-full"
					onClick={handleClick}
				>
					Post
				</button>
